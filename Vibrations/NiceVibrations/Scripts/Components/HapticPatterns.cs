...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticPatterns
    {
        ...
        static HapticPatterns()
        {
            ...
            VeryLight = new Preset(PresetType.Selection, new float[] { 0.0f, 0.02f },
                                                      new float[] { 0.120f, 0.120f });

            Selection = new Preset(PresetType.Selection, new float[] { 0.0f, 0.04f },
                                                         new float[] { 0.471f, 0.471f });

            Light = new Preset(PresetType.LightImpact, new float[] { 0.0f, 0.03f },
                                                       new float[] { 0.180f, 0.180f });
